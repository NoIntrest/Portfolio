    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-16">
      <div className="mb-14 text-center">
        ...
        <p className="mx-auto max-w-md text-sm text-muted-foreground">
          Each icon is a living micro-scene - rain falls, lightning flashes,
          sun rays rotate, and snowflakes drift. No hover required.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 justify-items-center gap-8 sm:grid-cols-4 md:grid-cols-6">
        {ALL_ICONS.map(({ name, Icon }) => (
          <div key={name} className="flex flex-col items-center gap-3">
            ...
            <span className="text-center text-[11px] leading-tight font-medium tracking-wide text-muted-foreground">
              {name}
            </span>
          </div>
        ))}
